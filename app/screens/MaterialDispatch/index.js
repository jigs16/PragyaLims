...
import {
  ...
  GetMaterialDispatchListApiCall,
  GetMaterialDispatchPrintByIDApiCall,
...
const MaterialDispatch = ({ navigation }) => {
  ...
  const GetMaterialDispatchListApi = async () => {
    ...
    var params = {
      ...
      PageSize: 10000,
      MaterialDispatchDateFrom: FromDate,
      MaterialDispatchDateTo: ToDate,
      MaterialDispatchNo: DispatchNumber,
      Search: "",
      Sorting: "",
      TCNo: TcNo,
    };
    console.log("GetMaterialDispatchListApi Params =====>>>>>>>>>>", params);
    GetMaterialDispatchListApiCall(params)
      .then((res) => {
        console.log(
          "GetMaterialDispatchListApi res ---->>>>>> ",
          JSON.stringify(res)
        );
        if (res.IsSuccess) {
  ...
  //GetCourierDDLListApiCall
  const GetMaterialDispatchPrintByIDApi = async (MaterialDispatchIDEncrypt) => {
    setLoading(true);
    var params = {
      MaterialDispatchIDEncrypt: MaterialDispatchIDEncrypt,
    };
    console.log("GetCustomerDDLListAJAXApi Params =====>>>>>>>>>>", params);
    GetMaterialDispatchPrintByIDApiCall(params)
      .then((res) => {
        if (res.IsSuccess) {
          setLoading(false);
