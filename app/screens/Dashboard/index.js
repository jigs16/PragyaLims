...
const Dashboard = ({navigation}) => {
  ...
  const data = {
    ...
    datasets: [{data: [4, 3, 7, 0, 0, 0, 0, 0, 0, 0, 0, 0]}],
  };
  ...
  const CustomerRenderLegendComponent = () => {
    return (
      <View
        ...
        {GetTopCustomersData?.map((item, index) => (
          <View
            key={index}
            style={{
              flexDirection: 'row',
  ...
  const DepartmentRenderLegendComponent = () => {
    return (
      <View
        ...
        {GetTopDepartmentData?.map((item, index) => (
          <View
            key={index}
            style={{
              flexDirection: 'row',
  ...
  const MachineRenderLegendComponent = () => {
    return (
      <View
        ...
        {GetTopMachinesData?.map((item, index) => (
          <View
            key={index}
            style={{
              flexDirection: 'row',
    ...
    <>
      ...
      <View style={[styles.contain]}>
        ...
        <View
          ...
          <Image
            resizeMode="contain"
            style={{width: 35, height: 35, borderRadius: 50, top: 5, right: 6}}
            source={Images.ic_avtar}></Image>

          <View>
            <Text darkColor bold style={{marginTop: 3}}>
              {FirstName}
            </Text>
          ...
          <View style={styles.container1}>
            <View style={styles.Card}>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={{flexDirection: 'row', paddingTop: 12, right: 6}}>
                  <Pressable
                    onPress={() => {
